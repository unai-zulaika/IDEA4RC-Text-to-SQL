# original code https://github.com/premAI-io/premsql/blob/main/premsql/evaluator/base.py
    ...
    def execute(
        ...
        for response in tqdm(model_responses, total=len(model_responses)):
            result = self._execute_model(
                ...
                dsn_or_db_path="Placeholder",  # TODO: solve? It doesn't do anything for IDEA4RC
